...
✓ Fully responsive and mobile optimized base theme (**[Theme Demo](http://joemccarthy.co.uk)**)  
...
[Open an Issue](https://github.com/orangefoundry/jekyllnow-with-tagging-and-pagination/issues/new) and let's chat!
...
You can start by [opening an issue](https://github.com/orangefoundry/jekyllnow-with-tagging-and-pagination/issues/new) describing the problem that you're looking to resolve and we'll go from there.
